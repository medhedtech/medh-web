            ...
            {courseCards.length === 0 ? (
              ...
              >
                {courseCards.map((course, index) => (
                  <div 
                    key={course.id}
                    className={`relative w-full flex-shrink-0 bg-gradient-to-br ${course.color} overflow-hidden min-h-[380px] md:min-h-[420px]`}
                  >
                    ...
                    <div className="relative z-10 w-full px-4 py-8 sm:py-10 lg:py-12 sm:px-6 lg:px-8 h-full flex items-center">
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-full px-10 md:px-16 w-full">
                        {/* Left side - Course information */}
                        <div className="md:col-span-8 flex flex-col justify-center">
                          <div className="flex flex-wrap items-center mb-3">
                            <span className="text-xs sm:text-sm bg-white/20 text-white px-3 py-1 rounded-full mr-2 mb-2 sm:mb-0">
                              {course.instructor}
                            </span>
                            <span className="text-xs sm:text-sm text-white/80 mb-2 sm:mb-0">
                              {greeting}, {userName}
                            </span>
                          </div>
                          ...
                          <div className="flex items-center mb-5 max-w-md">
                            ...
                            <span className="ml-3 text-white text-sm font-medium whitespace-nowrap min-w-[80px] text-right">
                              {course.progress}% complete
                            </span>
                          </div>
                          
                          <p className="text-white/80 text-base mb-6 max-w-2xl line-clamp-3">
                          ...
                          <div className="flex flex-wrap items-center gap-4 mt-2">
                            <Link 
                              ...
                              className="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-lg flex items-center transition-colors font-medium mb-2 sm:mb-0"
                            >
                            ...
                            <Link 
                              ...
                              className="border border-white/30 hover:bg-white/10 text-white px-6 py-3 rounded-lg flex items-center transition-colors mb-2 sm:mb-0"
                            >
                        ...
                        <div className="md:col-span-4 flex flex-col justify-center mt-6 md:mt-0">
                          <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/20 h-full max-h-[280px]">
                            <h3 className="text-white text-lg font-medium mb-3 flex items-center">
                              <Calendar className="h-5 w-5 mr-2" /> Next Up
                            </h3>
                            <div className="bg-white/10 rounded-lg p-4 mb-4">
                              <p className="text-white font-medium mb-1 line-clamp-2">{course.nextLesson}</p>
                              <div className="flex items-center text-white/70 text-sm">
                                <PlayCircle className="h-4 w-4 mr-1 flex-shrink-0" /> Estimated: 25 mins
                              </div>
                            </div>
                            <div className="grid grid-cols-2 gap-3 text-center">
                              <div className="bg-white/10 rounded-lg p-3">
                                <p className="text-white/70 text-xs mb-1">Completed</p>
                                <p className="text-white font-medium">{Math.floor(course.progress/10)}/10</p>
                              </div>
                              <div className="bg-white/10 rounded-lg p-3">
                                <p className="text-white/70 text-xs mb-1">Remaining</p>
                                <p className="text-white font-medium">{10-Math.floor(course.progress/10)}/10</p>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            {courseCards.length > 0 && (
              <>
                ...
                <button 
                  ...
                  className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 shadow-md z-20"
                ...
                <button 
                  ...
                  className="absolute right-3 md:right-6 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 shadow-md z-20"

...
const UsersTable = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: "Roger Workman", age: 48, email: "enteremail@gmail.com", joinDate: "2024/07/13", Domain: "Science", isActive: true },
    { id: 2, name: "Kianna Geidt", age: 76, email: "enteremail@gmail.com", joinDate: "2024/07/01", Domain: "Psychology", isActive: true },
    { id: 3, name: "Kadin Dokidis", age: 58, email: "enteremail@gmail.com", joinDate: "2024/07/04", Domain: "Communication", isActive: false },
    { id: 4, name: "Makenna Gouse", age: 52, email: "enteremail@gmail.com", joinDate: "2024/07/07", Domain: "web Devlopment", isActive: false },
    { id: 5, name: "Tiana Vetrovs", age: 45, email: "enteremail@gmail.com", joinDate: "2024/07/10", Domain: "App Devlopment", isActive: true },
    { id: 6, name: "Roger Aminoff", age: 65, email: "enteremail@gmail.com", joinDate: "2024/07/16", Domain: "Leadership", isActive: false },
  ]);
    ...
    <div className="flex items-start justify-center min-h-screen bg-gray-100 p-4 pt-9">
      <div className="w-full max-w-6xl bg-white p-8 md:p-10 rounded-lg shadow-md">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 space-y-4 md:space-y-0">
          <h2 className="text-xl font-semibold md:text-left">Instructor List</h2>
          <input
            type="text"

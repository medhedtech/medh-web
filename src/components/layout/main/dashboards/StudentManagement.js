...
const UsersTable = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: "Roger Workman", age: 48, email: "enteremail@gmail.com", joinDate: "2024/07/13", course: "Course 1", isActive: true },
    { id: 2, name: "Kianna Geidt", age: 76, email: "enteremail@gmail.com", joinDate: "2024/07/01", course: "Course 1", isActive: true },
    { id: 3, name: "Kadin Dokidis", age: 58, email: "enteremail@gmail.com", joinDate: "2024/07/04", course: "Course 1", isActive: false },
    { id: 4, name: "Makenna Gouse", age: 52, email: "enteremail@gmail.com", joinDate: "2024/07/07", course: "Course 1", isActive: false },
    { id: 5, name: "Tiana Vetrovs", age: 45, email: "enteremail@gmail.com", joinDate: "2024/07/10", course: "Course 1", isActive: true },
    { id: 6, name: "Roger Aminoff", age: 65, email: "enteremail@gmail.com", joinDate: "2024/07/16", course: "Course 1", isActive: false },
  ]);

...
const CoorporateEmployeeCourseDetails = () => {
  ...
  useEffect(() => {
    ...
    const getEnrollmentStatus = () => {
      getQuery({
        url: `${apiUrls?.Subscription?.getCoorporateEmployeeEnrollmentsStatus}?coorporateId=${coorporateId}&courseId=${courseId}`,
        onSuccess: (res) => {
...
export default CoorporateEmployeeCourseDetails;

      ...
      keyFeatures: [
        ...
        },
        {
          ...
          description:
            ...
            descript:"Reach out to us today to discuss your training needs and let us design a customized training plan that aligns with your goals and aspirations. Together,let’s embark on a journey of growth and success through our Corporate Training Solutions."
        },
      ],
    },
  };
    ...
    <div className="bg-white h-auto pt-10 pb-6 w-full flex justify-center items-center px-1 md:px-0">
      <div className="w-full md:w-[80%]">
        ...
        <div className="flex items-center flex-col w-80% md:mb-20 mb-10 px-4">
          <h1 className="text-[24px] leading-7 md:text-4xl font-bold md:mb-3 mb-2 text-[#000000]">
          ...
          Our SMART (Specific, Measurable, Achievable, Relevant, and Time-bound), approach ensures that the training is catering to your unique organizational goals.
          </p>
        </div>

...
const ActivityCard = ({ activity, onClick }) => (
  <div
    onClick={onClick}
    className="flex flex-col items-center justify-center bg-white shadow-md rounded-lg p-6 border border-gray-200 hover:shadow-lg transition cursor-pointer"
  >
    {activity.icon}
    <p className="mt-4 text-[#7ECA9D] font-bold text-center text-lg">
      {activity.title}
    </p>
  </div>
);

    ...
    <div className="bg-white h-auto pt-10 pb-6 w-full flex justify-center items-center px-1 md:px-0">
      <div className="w-full lg:w-[80%]">
        ...
        <div className="flex items-center flex-col w-80% md:mb-20 mb-10 px-4">
          <h1 className="text-[24px] leading-7 md:text-4xl font-bold md:mb-1 mb-2 text-[#000000]">
        ...
        {/* Content Rendering */}
        <section className="bg-white px-5 md:px-6 py-8 border-2 border-gray-300 text-lightGrey14 lg:mx-0 mx-2">

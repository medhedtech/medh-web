...
import { Search, ChevronDown, HelpCircle, AlertCircle, ExternalLink, BookOpen, Clock, Building, Coins, Users, Mail, Star, Crown, CreditCard, Shield, Download, Calendar } from "lucide-react";
            ...
            <div className="flex items-center mb-4 sm:mb-0">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mt-1">
                  Everything you need to know about MEDH Membership Programs
                </p>
              </div>
            </div>

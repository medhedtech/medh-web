...
const CareerFaq: React.FC = () => {
  ...
  return (
    <section className="bg-slate-50 dark:bg-slate-900 min-h-screen px-4 md:px-[50px]">
        {/* FAQ Content */}
      <div className={buildAdvancedComponent.contentCard() + " p-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-lg rounded-none sm:rounded-2xl px-4 md:px-[45px] py-[28px]"}>

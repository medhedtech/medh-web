    ...
    >
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-lg sm:rounded-xl md:rounded-2xl border border-white/50 dark:border-slate-600/50 p-4 sm:p-5 md:p-6 shadow-lg hover:shadow-xl shadow-slate-200/20 dark:shadow-slate-900/30 transition-all duration-300 h-full">
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          className="absolute top-2 right-2 w-8 h-8 bg-gradient-to-br from-blue-500 to-violet-500 rounded-full flex items-center justify-center"
        >
...
const WelcomeCareers: React.FC = () => {
  ...
  const features: IWelcomeCard[] = [
    ...
    },
    {
      ...
      description: "Opportunities for professional development and skill enhancement that grow with your career aspirations.",
  ...
  return (
    <div className="relative mb-16 md:mb-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-0 w-20 h-20 sm:w-24 sm:h-24 bg-blue-200/20 dark:bg-blue-800/20 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute bottom-10 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-violet-200/20 dark:bg-violet-800/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-800 rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-600 p-4 sm:p-6 md:p-8 shadow-sm shadow-slate-200/50 dark:shadow-slate-800/50 mb-8 md:mb-12 text-center"
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 bg-gradient-to-r from-blue-100 to-violet-100 dark:from-blue-900/30 dark:to-violet-900/30 text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-semibold rounded-full mb-4 backdrop-blur-sm border border-blue-200/50 dark:border-blue-700/50">
          ...
          >
            <button 
              onClick={() => {
                ...
                // If still not found, try to find the JobPositions component container
                if (!targetSection) {
        ...
        <motion.div
          ...
          animate={isVisible ? "visible" : "hidden"}
          variants={staggerContainer}
          className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-12 md:mb-16"
        >
        ...
        <motion.div
          ...
          animate={isVisible ? "visible" : "hidden"}
          variants={staggerContainer}
          className="bg-white dark:bg-slate-800 rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-600 p-4 sm:p-6 md:p-8 shadow-sm shadow-slate-200/50 dark:shadow-slate-800/50"
        >

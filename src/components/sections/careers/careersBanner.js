...
const features = [
  ...
  },
  {
    ...
    title: "Flexible Work",
    description: "Modern work environment with flexibility and autonomy"
  }
];

// Benefits highlights for careers
const benefits = [
  {
  ...
  },
  {
    ...
    title: "Recognition",
    description: "Celebrate achievements and reward exceptional performance"
  },
  {
    icon: <Star className="w-8 h-8" />,
    title: "Excellence",
    description: "Maintain high standards and deliver quality in everything"
  }
];
    ...
    <section className="relative min-h-[100dvh] bg-white dark:bg-gray-900 overflow-hidden py-8 sm:py-12 md:py-16 flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="w-full mx-auto max-w-7xl xl:max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-4xl md:text-3xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                ...
                <span className="block">THRIVE MEANINGFULLY</span>
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Our Career Values</h3>
          ...
          >
            <span className="text-sm text-gray-500 dark:text-gray-400 mb-2">Explore Career Opportunities</span>

...
const features = [
  ...
  },
  {
    ...
    description: "Foster stronger connections within your school community"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Curriculum Enhancement",
    description: "Enrich your existing curriculum with modern content"
  }
];

// Benefits highlights for schools
const benefits = [
  {
  ...
  },
  {
    ...
    description: "Dedicated educational consultants and ongoing assistance"
  }
];
    ...
    <section className="relative min-h-[100dvh] bg-white dark:bg-gray-900 overflow-hidden py-8 sm:py-12 md:py-16 flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="w-full mx-auto max-w-7xl xl:max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-4xl md:text-3xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                <span className="block">EMPOWER STUDENT</span>
                <span className="block">SUCCESS COMPREHENSIVELY</span>
          ...
          >
            <span className="text-sm text-gray-500 dark:text-gray-400 mb-2">Discover Partnership Options</span>

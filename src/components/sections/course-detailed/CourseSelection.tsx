                ...
                <AnimatePresence mode="wait">
                  {filteredCourses.map((course, index) => (
                    ...
                    >
                      {/* Selection Indicator */}
                      {selectedCourse?._id === course._id && (
                        <div className={`absolute top-3 right-3 p-1 rounded-full ${categoryInfo.bgClass}`}>
                      ...
                      <div className="flex flex-col space-y-3">
                        {/* Course Title */}
                        <h4 className="font-bold text-gray-900 dark:text-white text-base pr-8">{course.title}</h4>
                        ...
                        <div className="space-y-2">
                          {course.isFree ? (
                            ...
                            <div className="flex flex-col space-y-2">
                              ...
                              {/* Batch Pricing */}
                              <div className="flex items-center justify-between bg-emerald-50 dark:bg-emerald-900/20 rounded-lg px-3 py-2 border border-emerald-200 dark:border-emerald-800">
                                <div className="flex items-center space-x-2">

              ...
              <div>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-300">
                  <span className="font-medium">
                    {selectedCourse ? formatDuration(selectedCourse.course_duration) : 'Select duration'}
                  </span>
                </div>
              </div>
            </div>
                    ...
                    >
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Course Duration and Grade (conditionally) */}
                          <div className="flex flex-col gap-3">
                            ...
                            <div className="text-lg font-bold text-gray-900 dark:text-white">
                              {course.isFree ? (
                                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                                  Free
                                </span>
                              ) : (
                                formatPriceFunc(course.course_fee)
                              )}
                            </div>
                          </div>
                        </div>

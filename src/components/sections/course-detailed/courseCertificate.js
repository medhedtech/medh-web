...
const CertificateSection = () => {
  return (
    <section className="bg-white w-full md:pt-6  pb-10 md:px-4">
      <div className="flex flex-col md:flex-row items-center justify-between lg:w-[63%] w-[100%] lg:ml-[7%] px-4 md:px-0 ">
        ...
        <div className="mb-6 md:mb-0 border-t-2 border-l-2 border-b-2 border-gray-300 py-4  md:w-[50%] w-full text-center ">
          <h2 className="text-xl md:text-2xl font-bold text-[#5C6574] mb-2">Earn a certificate</h2>
          <p className="text-[#727695]">

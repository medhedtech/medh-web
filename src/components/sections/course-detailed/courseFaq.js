        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 md:p-8">
          ...
          {error && !loading && !courseLoading && (
            <motion.div 
              ...
              className="p-5 mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg flex flex-col items-center text-center"
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md inline-flex items-center transition-colors"
                onClick={handleRetry}
              >
          ...
          {noFaqsFound && !error && !loading && !courseLoading && (
            <motion.div 
              ...
              className="p-5 mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 rounded-lg"
            >
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                <HelpCircle className="w-10 h-10 mr-0 sm:mr-4 mb-3 sm:mb-0 flex-shrink-0 text-blue-500 dark:text-blue-400" />
                <div>
                  <h3 className="text-lg font-medium mb-2 text-center sm:text-left">No specific FAQs available for this course category yet</h3>
                  <p className="text-center sm:text-left">Our team is working on adding more FAQs for this specific course category. Meanwhile, check out our <a href="/faq" className="font-medium underline hover:text-blue-800 dark:hover:text-blue-200 inline-flex items-center">general FAQs page <ExternalLink className="w-3.5 h-3.5 ml-1" /></a> or contact our support team for assistance.</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {faqs.length > 0 && filteredFaqs.length === 0 && searchQuery && !loading && !courseLoading && (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.4 }}
              className="p-5 mt-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-center"
            >
            ...
            <p className="text-gray-700 dark:text-gray-300 flex flex-col sm:flex-row sm:items-center text-center sm:text-left">
              ...
              <span>
                ...
                <a href="/contact-us" className="font-medium mx-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline inline-flex items-center">
                  contact our support team<ExternalLink className="w-3.5 h-3.5 ml-1" />
                </a>.
              </span>
            </p>
          </motion.div>

...
const BlogDetails = ({ blog, relatedBlogs = [] }) => {
  // Fallback for when blog data might not be available
  ...
  useEffect(() => {
    if (blog) {
      ...
      if (blog.content) {
        ...
        const readTime = Math.ceil(wordCount / 200); // Avg reading speed of 200 words per minute
    ...
    const handleScroll = () => {
      if (contentRef.current) {
        ...
        // Find content's position relative to viewport
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (tocRef.current && !tocRef.current.contains(event.target) && window.innerWidth < 768) {
        setIsTocOpen(false);
      }
    };
  ...
  const toggleBookmark = () => {
    ...
    if (isBookmarked) {
      const updatedBookmarks = bookmarkedBlogs.filter(id => id !== blogId);
          ...
          <div className="lg:col-span-8 space-y-10">
            <div data-aos="fade-up">
              ...
              <div className="relative overflow-hidden rounded-2xl mb-8">
                ...
                <Image 
                  src={blogData.upload_image || blogImage21} 
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-gray-600 dark:text-gray-400 mb-6">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-medium">{blogData.author || "Medh Team"}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    ...
                    {isShareOpen && (
                      <div className="absolute top-full mt-2 right-0 z-30 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 min-w-[200px]">
                        <div className="flex flex-col gap-2">
                          ...
                          <button 
                            onClick={() => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(blogData.title)}`, '_blank')}
                            className="flex items-center gap-2 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors w-full text-left"
                          >
              ...
              >
                {blogData.content ? (
                  ...
                  <>
                    ...
                    <h2 id="section-1">Understanding the Basics</h2>
                    <p>
                    ...
                    <h3 id="section-1-1">Key Concepts to Remember</h3>
                    <p>
                      Interdum et malesuada fames ac ante ipsum primis in faucibus. 
                      Quisque at tellus felis. Sed eget tempor est. Phasellus rutrum, 
                      neque pellentesque pharetra elementum, magna lectus finibus est, 
                      in varius nisi eros at augue. Donec commodo lacinia eros eu commodo.
                    </p>
                    
                    <h2 id="section-2">Advanced Techniques</h2>
                    <p>
                      In hac habitasse platea dictumst. Curabitur commodo lacus ex. 
                      Ut consequat ante nec sem laoreet bibendum. Suspendisse potenti. 
                      Nam volutpat libero eget nisl porta, eget posuere leo consequat. 
                      Donec vestibulum elementum orci, at faucibus est tempus malesuada.
                    </p>
                    
                    <h3 id="section-2-1">Practical Applications</h3>
                    <p>
                      Fusce quam sapien, tempus et augue ac, tempus volutpat libero. 
                      Duis non dapibus eros, a faucibus diam. Nam in dui risus. 
                      Aliquam a risus sed elit porttitor tempus. 
                      Fusce aliquam ante ipsum, vel semper dui facilisis vitae.
                    </p>
                  </>
                )}
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 md:p-8 mb-10">
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{blogData.author || "Medh Team"}</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-3">
                      Education expert and content creator at Medh. Passionate about making learning accessible to everyone.
                    </p>
                    <div className="flex gap-2">
                      <Link href="/about" className="text-primary-600 dark:text-primary-400 text-sm font-medium hover:underline">
                        View Profile
                      </Link>
                      <span className="text-gray-400">•</span>
                      <Link href="/blogs?author=medh-team" className="text-primary-600 dark:text-primary-400 text-sm font-medium hover:underline">
                        More Articles
                      </Link>
                    </div>
                  </div>

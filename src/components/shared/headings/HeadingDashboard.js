...
const HeadingDashboard = ({ userName = "Manik", setIsFocused, isFocused }) => {
  const [searchTerm, setSearchTerm] = useState("");

  return (
    <div className="flex p-10px md:px-10 md:py-50px flex-col md:flex-row gap-4 w-full py-4">
      {isFocused ? (
        // Focused layout
        <div className="flex flex-col gap-4 w-full px-4">
          ...
          <div className="flex items-center bg-white border dark:bg-inherit border-gray-300 rounded-full shadow-md px-4 py-3 w-full">

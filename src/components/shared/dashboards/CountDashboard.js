...
const CountDashboard = ({ count }) => {
  ...
  return (
    <div className="md:px-0 md:py-0px flex justify-between bg-white dark:bg-whiteColor-dark rounded-3xl shadow-accordion-dark hover:bg-customGreen">
      ...
      <div className="flex flex-col justify-between gap-4">
        ...
        <p className="text-black p-4 font-medium leading-[18px] dark:text-whiteColor-dark">
          {name}
        </p>
      </div>
      <div>

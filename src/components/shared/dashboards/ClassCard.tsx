...
/**
 * ClassCard - A reusable component for displaying class information
 * Used in dashboard areas to show upcoming, live, and past classes
 */
  ...
  return (
    <div 
      className={`bg-white dark:bg-gray-800 rounded-2xl p-6 border ${
        isLive ? 'border-red-200 dark:border-red-800' : 'border-gray-200 dark:border-gray-700'
...
export type { IUpcomingClass, IClassCardProps };

...
export class AdvancedSEOOptimizer {
  // Provide legacy mega education keywords for page.tsx
  static MEGA_EDUCATION_KEYWORDS = {
    primary: ADVANCED_EDUCATION_KEYWORDS_2025.primaryIntentClusters.learning,
    secondary: ADVANCED_EDUCATION_KEYWORDS_2025.primaryIntentClusters.skills,
    longTail: ADVANCED_EDUCATION_KEYWORDS_2025.conversationalQueries,
    trending: ADVANCED_EDUCATION_KEYWORDS_2025.emergingTech2025,
    geographic: [
      ...ADVANCED_EDUCATION_KEYWORDS_2025.globalKeywords.india,
      ...ADVANCED_EDUCATION_KEYWORDS_2025.globalKeywords.international
    ]
  };

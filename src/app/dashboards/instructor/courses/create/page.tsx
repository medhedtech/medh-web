      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Choose the type of course you want to create. Each type is optimized for different learning experiences and teaching styles.
            </p>
          </div>
        </div>
        ...
        {selectedType && (
          <div className="text-center">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
              ...
              <Link
                href={`/dashboards/instructor/courses/create/${selectedType}`}
        ...
        <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
          <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-4 flex items-center">
            ...
            Instructor Tips for Course Creation
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800 dark:text-blue-200">
            <div>
              <h4 className="font-medium mb-2">Planning Your Course:</h4>
              <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                <li>• Define clear learning objectives</li>
                <li>• Break content into digestible modules</li>
                <li>• Plan interactive elements and assessments</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium mb-2">Engaging Your Students:</h4>
              <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                <li>• Use multimedia content (videos, images, PDFs)</li>
                <li>• Include quizzes and practical assignments</li>
                <li>• Foster community through discussions</li>
              </ul>
            </div>
          </div>
        </div>

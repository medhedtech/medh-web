...
// Dynamic import for VideoTutorialsContent component
const VideoTutorialsContent = dynamic(() => import('@/components/layout/main/dashboards/VideoTutorialsContent'), {
  loading: () => (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="text-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-red-600 mx-auto"></div>
        <p className="mt-2 text-sm text-gray-500">Loading video tutorials...</p>
      </div>
    </div>
  ),
});
...
const VideoTutorialsPage: React.FC = () => {
  ...
  return (
    ...
    >
      {studentId && <VideoTutorialsContent />}
    </StudentDashboardLayout>
  );
};

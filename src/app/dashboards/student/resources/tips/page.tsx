...
// Dynamic import for StudyTipsContent component
const StudyTipsContent = dynamic(() => import('@/components/layout/main/dashboards/StudyTipsContent'), {
  loading: () => (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="text-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-emerald-600 mx-auto"></div>
        <p className="mt-2 text-sm text-gray-500">Loading study tips...</p>
      </div>
    </div>
  ),
});

const StudyTipsPage: React.FC = () => {

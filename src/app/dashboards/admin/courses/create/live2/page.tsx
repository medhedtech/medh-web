...
export default function Live2CourseForm() {
  ...
  const { register, handleSubmit, watch, setValue, control, formState: { errors, isDirty } } = useForm<Live2FormData>({
  ...
  const onSubmit = async (data: Live2FormData, event?: React.FormEvent) => {
    ...
    try {
      ...
      const liveCourseData: ILiveCourse = {
        ...
        course_subcategory: cleanedData.parentCategory,
      ...
      console.log('Transformed course data:', liveCourseData);
          ...
          <div className={sectionClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select {...register("parentCategory")} className={inputClass}>
                  <option value="">Select parent category</option>
                  {masterData.parentCategories && masterData.parentCategories.length > 0 ? (
                    masterData.parentCategories.map((cat, i) => (
                      <option key={i} value={cat}>{cat}</option>
                    ))
                  ) : (
                    <option disabled>Loading parent categories...</option>
                  )}
                </select>
                {errors.parentCategory && <p className={errorClass}>{errors.parentCategory.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.courseTags && <p className={errorClass}>{errors.courseTags.message}</p>}
              </div>
            </div>
          </div>
          ...
          <div className={sectionClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                {errors.courseTitle && <p className={errorClass}>{errors.courseTitle.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.courseImage && <p className={errorClass}>{errors.courseImage.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.classType && <p className={errorClass}>{errors.classType.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.courseDuration && <p className={errorClass}>{errors.courseDuration.message}</p>}
              </div>
          ...
          <div className={sectionClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {errors.gradeOrCertificate && <p className={errorClass}>{errors.gradeOrCertificate.message}</p>}
              </div>
              ...
              {watch("gradeOrCertificate") === "certificate" && (
                <div>
                  ...
                  {errors.certificateType && <p className={errorClass}>{errors.certificateType.message}</p>}
                </div>
              )}
            </div>
          </div>
              ...
              <div key={field.id} className="mb-6 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {errors.pricing?.[index]?.currency && <p className={errorClass}>{errors.pricing[index].currency.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.01"
                    />
                    {errors.pricing?.[index]?.individual && <p className={errorClass}>{errors.pricing[index].individual.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.01"
                    />
                    {errors.pricing?.[index]?.batch && <p className={errorClass}>{errors.pricing[index].batch.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="2"
                    />
                    {errors.pricing?.[index]?.minBatchSize && <p className={errorClass}>{errors.pricing[index].minBatchSize.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="2"
                    />
                    {errors.pricing?.[index]?.maxBatchSize && <p className={errorClass}>{errors.pricing[index].maxBatchSize.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      max="100"
                    />
                    {errors.pricing?.[index]?.earlyBirdDiscount && <p className={errorClass}>{errors.pricing[index].earlyBirdDiscount.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      max="100"
                    />
                    {errors.pricing?.[index]?.groupDiscount && <p className={errorClass}>{errors.pricing[index].groupDiscount.message}</p>}
                  </div>
          ...
          <div className={sectionClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                {errors.programOverview && <p className={errorClass}>{errors.programOverview.message}</p>}
              </div>
          ...
          <div className={sectionClass}>
            ...
            <div className="space-y-4">
              {watch('brochures') && watch('brochures').length > 0 ? (
                <div className="space-y-2">
                  {watch('brochures').map((brochure, index) => (

...
import { FaArrowLeft, FaRobot, FaUser, FaCalculator, FaChartLine, FaGraduationCap } from "react-icons/fa";
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 p-0.5">
                <div className="w-full h-full bg-white dark:bg-gray-800 rounded-2xl flex items-center justify-center">
                  <FaGraduationCap className="text-2xl text-gray-700 dark:text-gray-300" />
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  free trial sessions - choose your category
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {categories.map((category) => {
            ...
            return (
              <Link
                key={category.id}
                href={`/dashboards/admin/online-class/Demo/${category.id}`}
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-700 p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              Create and manage free trial sessions across all categories. Demo classes are perfect for showcasing your teaching methodology and giving students a taste of what to expect from your courses.
            </p>
          </div>
        </div>
      </div>

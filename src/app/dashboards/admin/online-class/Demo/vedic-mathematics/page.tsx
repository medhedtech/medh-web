...
export default function DemoVedicMathematicsPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 p-0.5">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                    Demo Classes - Vedic Mathematics
                  </h1>
                  <span className="text-2xl">🧮</span>
                </div>
                <p className="text-gray-600 dark:text-gray-400">
                  free trial sessions for vedic mathematics courses
                </p>
              </div>
            </div>
          </div>
      ...
      <OnlineClass 
        categoryFilter="Vedic Mathematics" 
        sessionTypeFilter="demo"
        pageTitle="Demo Classes - Vedic Mathematics"
      />
    </div>
  );
} 
...
export default function DemoPersonalityDevelopmentPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                    Demo Classes - Personality Development
                  </h1>
                  <span className="text-2xl">✨</span>
                </div>
                <p className="text-gray-600 dark:text-gray-400">
                  free trial sessions for personality development courses
                </p>
              </div>
            </div>
          </div>
      ...
      <OnlineClass 
        categoryFilter="Personality Development" 
        sessionTypeFilter="demo"
        pageTitle="Demo Classes - Personality Development"
      />
    </div>
  );
} 
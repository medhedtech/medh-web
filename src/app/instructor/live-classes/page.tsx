...
/**
 * LiveClassesPage - Live Classes management
 */
const LiveClassesPage: React.FC<LiveClassesProps> = ({ searchParams }) => {
  
  // State management
  const [data, setData] = useState<LiveClassesData>({
    data: [],
    loading: true,
    error: null
  });
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await instructorApi.getAssignedBatches();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your live classes efficiently
              </p>
            </div>

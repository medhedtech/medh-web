...
/**
 * LearningOutcomesPage - Learning Outcomes management
 */
const LearningOutcomesPage: React.FC<LearningOutcomesProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your learning outcomes efficiently
              </p>
            </div>

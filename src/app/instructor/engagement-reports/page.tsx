...
interface EngagementReportsData {
...
/**
 * EngagementReportsPage - Engagement Reports management
 */
const EngagementReportsPage: React.FC<EngagementReportsProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your engagement reports efficiently
              </p>
            </div>

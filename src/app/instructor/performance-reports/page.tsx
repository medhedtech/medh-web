...
interface PerformanceReportsData {
...
/**
 * PerformanceReportsPage - Performance Reports management
 */
const PerformanceReportsPage: React.FC<PerformanceReportsProps> = ({ searchParams }) => {

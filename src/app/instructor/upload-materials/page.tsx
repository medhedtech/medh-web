...
/**
 * UploadMaterialsPage - Upload Materials management
 */
const UploadMaterialsPage: React.FC<UploadMaterialsProps> = ({ searchParams }) => {
  
  // State management
  const [data, setData] = useState<UploadMaterialsData>({
    data: [],
    loading: true,
    error: null
  });
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await instructorApi.uploadCourseMaterial();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your upload materials efficiently
              </p>
            </div>

...
/**
 * DemoRecordingsPage - Demo Recordings management
 */
const DemoRecordingsPage: React.FC<DemoRecordingsProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your demo recordings efficiently
              </p>
            </div>

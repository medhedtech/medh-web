...
/**
 * SubmittedWorkPage - Submitted Work management
 */
const SubmittedWorkPage: React.FC<SubmittedWorkProps> = ({ searchParams }) => {
  
  // State management
  const [data, setData] = useState<SubmittedWorkData>({
    data: [],
    loading: true,
    error: null
  });
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await instructorApi.getAssignmentSubmissions();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your submitted work efficiently
              </p>
            </div>

...
/**
 * AttendanceReportsPage - Attendance Reports management
 */
const AttendanceReportsPage: React.FC<AttendanceReportsProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your attendance reports efficiently
              </p>
            </div>

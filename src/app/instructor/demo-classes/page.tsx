...
/**
 * DemoClassesPage - Demo Classes management
 */
const DemoClassesPage: React.FC<DemoClassesProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your demo classes efficiently
              </p>
            </div>

...
/**
 * LiveRecordingsPage - Live Recordings management
 */
const LiveRecordingsPage: React.FC<LiveRecordingsProps> = ({ searchParams }) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your live recordings efficiently
              </p>
            </div>

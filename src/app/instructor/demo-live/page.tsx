...
/**
 * DemoLivePage - Demo Live management
 */
const DemoLivePage: React.FC<DemoLiveProps> = ({ searchParams }) => {
  
  // State management
  const [data, setData] = useState<DemoLiveData>({
    data: [],
    loading: true,
    error: null
  });
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await instructorApi.getDemoClasses();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Manage your demo live efficiently
              </p>
            </div>

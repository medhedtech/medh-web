            ...
            <div className="container mx-auto px-4">
              ...
              <div className="flex flex-col-reverse lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-8/12 space-y-8">
                  ...
                  <section id="about" ref={sectionRefs.about} className="scroll-mt-24">
                    <AboutProgram courseId={selectedCourse?._id} />
                  </section>

                  {/* Reviews Section */}
                  <section id="reviews" ref={sectionRefs.reviews} className="scroll-mt-24">
                    <CourseRelated 
                  ...
                  {selectedCourse?.is_Certification && (
                    <section id="certificate" ref={sectionRefs.certificate} className="scroll-mt-24">
                      <CourseCertificate />
                    </section>
                  )}
                          ...
                          {recommendedCategories.map((category) => {
                            ...
                            return (
                              <motion.div
                                ...
                                whileTap={{ scale: 0.98 }}
                                className={`cursor-pointer rounded-xl overflow-hidden shadow-sm border hover:shadow-md transition-all duration-300 ${colorClasses.border}`}
                                onClick={() => {
                                  router.push(`/enrollment/${category.id}`);
                                }}
                              >
                                <div className={`p-5 h-full ${colorClasses.bg}`}>
                                  <div className="flex justify-between items-start mb-4">
                                    <div className={`p-3 w-12 h-12 rounded-lg flex items-center justify-center ${colorClasses.bgIcon}`}>
                                      <Icon className={`h-6 w-6 ${colorClasses.text}`} />
                                    </div>
                                  </div>
                                  
                                  <h4 className={`text-lg font-bold mb-2 ${colorClasses.heading}`}>
                                    {category.name}
                                  </h4>
                                  ...
                                  <div className="flex items-center text-sm font-medium">
                                    ...
                                    >
                                      ...
                                      <ArrowRight className={`h-4 w-4 ml-1 ${colorClasses.text}`} />
                                    </motion.div>
                                  </div>
                                </div>
                              </motion.div>
                ...
                <div className="w-full lg:w-4/12">
                  <div className="lg:sticky lg:top-24 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
